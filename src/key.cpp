...
#include <openssl/opensslv.h>  //huns add  key erorr
...
//////////////////////// huns modifiy key erorr //////////////////////////////////
    // if (BN_cmp(sig->s, halforder) > 0) {  //huns delete  key erorr
        // enforce low S values, by negating the value (modulo the order) if above order/2.
	BIGNUM *s = 0;  //huns add  key erorr
    ECDSA_SIG_get0(sig, 0, (const BIGNUM **)&s);   //huns add  key erorr
    if (BN_cmp(s, halforder) > 0) {	 //huns add  key erorr
      //  BN_sub(sig->s, order, sig->s);   //huns delete  key erorr
		 BN_sub(s, order, s);
    }
/////////////////////////////////////////////////////////////////////////////////
    BN_free(halforder);
