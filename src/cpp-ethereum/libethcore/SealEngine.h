...
////////////////////////////////////////////////////////////// // ajwm
	void setAjwmSchedule(EVMSchedule _ajwmSchedule) const { ajwmSchedule = _ajwmSchedule; }

	EVMSchedule& getAjwmSchedule() const { return ajwmSchedule; }
...
private:
	...
	mutable EVMSchedule ajwmSchedule; // ajwm
