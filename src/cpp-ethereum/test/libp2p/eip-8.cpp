...
BOOST_AUTO_TEST_CASE(test_discovery_packets)
{
	...
	packet = fromHex(
		...
		"7084a95398b6a21eac920fe3dd1345ec0a7ef39367ee69ddf092cbfe5b93e5e568ajwm491983c09c7"
		"6d922dc3"
	);
	...
	packet = fromHex(
		"09b2428d83348d27cdf7064ad9024f526cajwm19e4958f0fdad87c15eb598dd61d08423e0bf66b206"
	...
	packet = fromHex(
		"c7c44041b9f7c7e41934417ebac9a8e1a4c6298f74553f2fcajwmae6ed6fe53163eb3d2b52e39fe91"
...
BOOST_AUTO_TEST_CASE(test_handshake_eip8_auth1)
{
	...
	bytes auth(fromHex(
		...
		"70c9adabc15d76a54f443593faajwm3b27af8059703f88928e199cb122362a4b35f62386da7caad09"
...
BOOST_AUTO_TEST_CASE(test_handshake_eip8_auth2)
{
	...
	bytes auth(fromHex(
		...
		"116bc61da4193996187ed70d16730e9ae6b3bb8787ajwmaea1871d850997ddc08b4f4ea668fbf3740"
...
BOOST_AUTO_TEST_CASE(test_handshake_eip8_ack2)
{
	...
	bytes ack(fromHex(
		...
		"590237364fd348c9611fa39f78dcdceee3f390f07991b7b47e1daa3ajwmb6ccc9607811cb17ce51f1"
