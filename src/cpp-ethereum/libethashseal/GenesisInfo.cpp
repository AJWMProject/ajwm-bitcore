...
#include "genesis/ajwmMainNetwork.cpp"
#include "genesis/ajwmTestNetwork.cpp"
...
std::string const& dev::eth::genesisInfo(Network _n)
{
	...
	case Network::ajwmMainNetwork: return c_genesisInfoAjwmMainNetwork;
	case Network::ajwmTestNetwork: return c_genesisInfoAjwmTestNetwork;
	default:
...
h256 const& dev::eth::genesisStateRoot(Network _n)
{
	...
	case Network::ajwmMainNetwork: return c_genesisStateRootAjwmMainNetwork;
	case Network::ajwmTestNetwork: return c_genesisStateRootAjwmTestNetwork;
	default:
		throw std::invalid_argument("Invalid network value");
	}
}
