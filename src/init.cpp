    ...
    while (!fLoaded) {
        ...
        do {
            try {
                ...
                if (fReindex) {
                    boost::filesystem::path stateDir = GetDataDir() / "stateAjwm";
                ...
                boost::filesystem::path ajwmStateDir = GetDataDir() / "stateAjwm";

                bool fStatus = boost::filesystem::exists(ajwmStateDir);
                ...
                pstorageresult = new StorageResults(ajwmStateDir.string());
